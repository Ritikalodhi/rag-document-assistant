    ...
    <div className="flex flex-col gap-7">
      ...
      <motion.div {...motionProps(0.05)} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="p-5 rounded-[14px] border border-[rgb(var(--color-border))] bg-[rgb(var(--color-elevated))] shadow-[var(--shadow-sm)] flex flex-col gap-4 hover:border-[rgb(var(--color-accent))]/30 hover:shadow-[var(--shadow-md)] transition-all duration-200"
          >
